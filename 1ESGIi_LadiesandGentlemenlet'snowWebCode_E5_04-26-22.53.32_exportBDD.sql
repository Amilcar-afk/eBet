...
INSERT INTO `BET` VALUES (64,22,3.13,100,'2020-04-26 02:05:45',4,4),(65,22,2.75,50,'2020-04-26 02:05:47',2,2),(66,22,2.56,60,'2020-04-26 02:18:13',2,9);
...
INSERT INTO `CATEGORY` VALUES (1,'MMORPG','Massive Multiplayer Online Role Play Game'),(2,'FPS','First Person Shooter'),(3,'MOBA','bazifbaifbazif'),(4,'RPG','role players games'),(5,'horror','scary games'),(6,'Sport','sport games ');
...
INSERT INTO `FAVOURITE` VALUES (8,10),(8,11),(12,4),(12,9),(23,1),(23,2),(23,4),(23,9),(23,50);
...
INSERT INTO `FOLLOWER` VALUES (8,7),(22,7),(7,8),(10,8),(12,8),(21,8),(22,8),(13,12),(8,22),(21,22),(21,23),(30,23);
...
CREATE TABLE `HISTORY` (
  ...
  `id_looser` int(11) DEFAULT NULL,
  `score` varchar(6) DEFAULT NULL,
  `dateV` date DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `MATSH` VALUES (3,'sparta',1,4,5,'2020-03-31 00:00:00',1),(5,'LYON e-sprt',1,5,1,'2020-04-03 01:00:00',1),(6,'coco',1,2,3,'2020-04-09 00:00:00',1),(7,'channel',2,2,3,'2020-04-08 15:00:00',1),(8,'wartek',3,2,3,'2020-04-11 15:00:00',1),(11,'SPARTIATE',4,5,2,'2020-04-21 15:00:00',1),(13,'AZERT ESPORT',2,3,1,'2019-11-01 01:00:00',1),(14,'FR',4,4,6,'2016-03-05 01:01:00',1),(17,'Six Invitational',7,4,3,'2019-12-30 22:59:00',1),(18,'AZERT ESPORT',7,7,8,'2019-12-31 23:59:00',1),(20,'AZERT ESPORT',4,3,2,'2016-12-31 20:57:00',1),(21,'AZERT ESPORT',4,3,2,'2019-11-30 21:57:00',1),(22,'AZERTY ESPORT',4,5,4,'2018-11-29 23:58:00',1),(23,'FR',7,4,3,'2016-10-29 20:54:00',1),(26,'Six Invitational',5,7,8,'2019-01-01 23:59:00',1),(27,'Six Invitational',5,2,2,'2017-12-31 22:59:00',1),(28,'Six Invitational',5,1,2,'2017-10-30 22:57:00',1),(29,'TRACK',7,7,6,'2020-04-20 15:15:00',1),(30,'RAMBO',4,5,2,'2020-04-20 15:32:00',1),(31,'Six Invitational',2,3,2,'2020-04-20 15:37:00',1),(32,'FR',3,5,6,'2020-04-20 15:42:00',1),(33,'AMIL ESPORT',4,5,4,'2020-04-20 15:45:00',1),(34,'GREG',3,3,2,'2020-04-20 15:52:00',1),(35,'Rainbow Six Siege',2,6,8,'2020-04-20 15:56:00',1),(36,'gregezgrezgergerg',3,3,2,'2020-04-20 16:00:00',1),(37,'azertyuknbvcf',4,5,4,'2020-04-20 16:08:00',1),(38,'kjebzfzebfmozebfmoz',2,3,1,'2020-04-20 16:10:00',1),(39,'123',4,2,3,'2020-04-20 16:13:00',1),(40,'123445',3,4,8,'2020-04-20 16:16:00',1),(41,'098',3,3,4,'2020-04-20 16:17:00',1),(42,'987',4,6,7,'2020-04-20 16:19:00',1),(43,'Six Invitational',7,5,1,'2020-04-20 16:23:00',1),(46,'AZERT ESPORT',2,1,1,'2018-12-01 22:59:00',1),(47,'TEST_COTE',1,2,6,'2020-04-23 17:00:00',1),(48,'TEST',7,6,7,'2019-12-31 23:59:00',1),(49,'NOTIF',4,3,8,'2020-04-23 23:27:00',1),(50,'BELLA CIAO',6,4,9,'2020-04-24 00:47:00',1),(51,'ORIEGETON',4,6,3,'2020-04-24 00:50:00',1),(52,'GGGG',1,5,1,'2020-04-24 01:10:00',1),(53,'NNNN',8,3,6,'2020-04-24 01:10:00',1),(54,'RRRR',5,3,1,'2020-04-24 01:12:00',1),(55,'BBBB',4,2,8,'2020-04-24 01:12:00',1),(56,'QSD',4,3,1,'2020-04-24 01:17:00',1),(57,'FGH',6,5,7,'2020-04-24 01:17:00',1),(58,'OOII',2,2,4,'2020-04-24 01:21:00',1),(61,'YANIS_LMC',1,4,8,'2020-04-26 02:30:00',1),(62,'5546',7,3,1,'2020-04-26 03:52:00',1),(63,'TETETE',5,2,9,'2020-04-26 03:54:00',1),(64,'ZEQUINHA',2,4,9,'2020-04-26 04:05:00',1),(65,'NONO',10,4,2,'2020-04-26 04:05:00',1),(66,'GFGFg',1,2,9,'2020-04-26 04:18:00',1);
...
CREATE TABLE `NOTIF` (
  ...
  `dateh` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `NOTIF` VALUES (19,NULL,'You have completed a bet !',22,'2020-04-23 23:17:01',56),(20,NULL,'You have completed a bet !',22,'2020-04-23 23:17:01',57),(21,NULL,'You have completed a bet !',22,'2020-04-23 23:21:13',58),(22,NULL,'You have completed a bet !',22,'2020-04-26 00:45:37',61),(23,NULL,'You have completed a bet !',22,'2020-04-26 01:52:42',62),(24,NULL,'You have completed a bet !',22,'2020-04-26 01:54:07',63),(25,NULL,'You have completed a bet !',22,'2020-04-26 02:05:40',64),(26,NULL,'You have completed a bet !',22,'2020-04-26 02:05:40',65),(27,NULL,'You have completed a bet !',22,'2020-04-26 02:18:19',66);
...
CREATE TABLE `REPORT` (
  ...
  PRIMARY KEY (`id_user`,`user_report`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `REPORT` VALUES (1,21),(2,21),(8,21),(22,21),(22,23);
...
INSERT INTO `SHARE_BET` VALUES (12,4),(12,11),(13,4),(13,9),(21,11),(23,9);
...
CREATE TABLE `TEAM` (
  ...
  `nb_victory` int(11) DEFAULT 0,
  `nb_lose` int(11) DEFAULT 0,
  PRIMARY KEY (`id`)
...
INSERT INTO `TEAM` VALUES (1,'Method Black',4,'METHOD EU','2002-03-04',5,8),(2,'ZWARRIORS',4,'WWE ESPORT','2002-03-04',3,1),(3,'KPA R6 TEAM 1',5,'KPA ESPORT','2002-03-04',0,5),(4,'GIGN R6 TEAM 1',5,'GIGN ESPORT','2002-03-04',5,2),(5,'MILLENIUM',5,'BTP ESPORT','2002-03-04',20,15),(6,'G2 R6',5,'G2','2002-03-04',10,1),(7,'PENTA R6',5,'PENTA','2002-03-04',5,5),(8,'LIQUID R6',5,'LIQUID','2002-03-04',2,6),(9,'EMPIRE R6',5,'EMPIRE','2007-03-05',4,5);
...
INSERT INTO `TRACK` VALUES (1,'signup',3,'2020-04'),(2,'signup',15,'2020-03'),(3,NULL,0,'2020-04'),(4,NULL,0,'2020-04'),(5,NULL,0,'2020-04'),(6,NULL,0,'2020-04'),(7,NULL,0,'2020-04'),(8,NULL,0,'2020-04'),(9,NULL,0,'2020-04'),(10,NULL,0,'2020-04'),(11,NULL,0,'2020-04'),(12,NULL,0,'2020-04'),(13,NULL,0,'2020-04'),(14,NULL,0,'2020-04'),(15,NULL,0,'2020-04'),(16,NULL,0,'2020-04'),(17,NULL,0,'2020-04'),(18,NULL,0,'2020-04'),(19,NULL,0,'2020-04'),(20,NULL,0,'2020-04'),(21,NULL,0,'2020-04'),(22,NULL,0,'2020-04'),(23,NULL,0,'2020-04'),(24,NULL,0,'2020-04'),(25,NULL,0,'2020-04'),(26,NULL,0,'2020-04'),(27,NULL,0,'2020-04'),(28,NULL,0,'2020-04'),(29,NULL,0,'2020-04'),(30,NULL,0,'2020-04'),(31,NULL,0,'2020-04');
...
INSERT INTO `USR` VALUES (7,'g-mrn@gmx.com','adm','adm','grgoire44','111fe611704dc421b65ba8f5234730deccb0f3c9023fb3e082a8ac152fded3af',1130,1,'0166666666','795941588666',0,0,0,'86.245.46.217','image-1585573664.jpg',0,0),(9,'test0@yopmail.com','testerreur','testerreur','test0','5859287955847c73dddeba0a3eb34aebb9c52f4f56a330c93e59e17f72f52d47',100,1,'Test123456','196226777741',0,0,0,'82.251.191.80','image-1585575210.png',0,0),(10,'letourneaunathan7@gmail.com','Letourneau','Nathan','nathan77','092b191016eb415a5446983dfb103a0859b8dd6a47ff5e0e0b913a111c892a64',100,75,'5555555555','387686094415',0,0,0,'89.80.47.126','image-1586288874.jpg',0,0),(11,'project.parionsweb@gmail.com','testerreur','testerreur','testerreur','458f52b87ae8981c7bd21a9b9b780c2b8be094d173b31073324f365c18cbb3e0',100,75,'0606060606','917481366648',1,0,0,'82.251.191.80','image-1586603866.jpg',0,0),(14,'nathan.letourneau@net-c.com','Letourneau','Nathan','rondin','092b191016eb415a5446983dfb103a0859b8dd6a47ff5e0e0b913a111c892a64',100,75,'9999999999','776543168102',0,0,0,'89.80.47.126','image-1586893382.jpg',0,0),(15,'other@other.fr','Letourneau','Nathan','proutdu77','092b191016eb415a5446983dfb103a0859b8dd6a47ff5e0e0b913a111c892a64',100,75,'5555555555','531503167616',0,0,0,'89.80.47.126','image-1586893554.jpg',0,0),(21,'blackoscapos@gmail.com','Goku','Vegeta','kakarootoo','a9ea23d80f977f2200ef5ca604e48f8fe2b6999fa5bebefee7dab5a8fe4c2918',3492,1,'0633406481','724077372437',1,0,0,'93.23.15.5','image-1587146146.png',3,0),(22,'fernandesamilcar28@gmail.com','Wayne','Bruce','Batman94','af411b6e68157b220f4df7693f9928d2cd7ca11eb1a701f6d019604525ae0e7b',758.5,133,'0633406481','112947976408',1,0,5,'93.23.15.5','image-1587147187.png',0,0),(23,'alexandremarcos94100@gmail.com','Amilkush','gregouse','gkata','c3ca698383e5061e3ee44758c24ae3c10dabcbb767bdcbc91edb234b25d3f440',149921,75,'0658321973','381413411877',0,0,0,'62.35.116.206','image-1587218990.jpg',57,0);
...
-- Dump completed on 2020-04-26 22:34:28
